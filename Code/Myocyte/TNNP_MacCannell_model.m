...
v_f=-48.316437192572480;
fr_Kv=0.070816016761234;
fs_Kv=0.973830281506670;
%--------------------------------------------------------------------------
...
while time<=endtime
    ...
    if Num_Fb==0
        v_f=v_f-dt*(fI);
    elseif Num_Fb>0
        v_f=v_f-dt*(fI+I_inter_fib/C_fm);
    end
...
dlmwrite('TNNP_MacCannell.txt',AA1,'delimiter','\t','precision',6)
t2 = clock;
